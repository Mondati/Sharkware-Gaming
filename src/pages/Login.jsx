...
import { Mail, Lock, LogIn, Globe, Smartphone, ShieldCheck, Truck, RefreshCw, Eye, EyeOff, UserRound } from 'lucide-react'
...
const Login = () => {
  ...
  return (
    <div className="flex" style={{ minHeight: '100vh', backgroundColor: '#070B16' }}>
