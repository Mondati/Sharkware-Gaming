  ...
  return (
    <div className="flex flex-col flex-1" style={{ backgroundColor: '#070B16' }}>
      ...
      <div className="hidden md:flex items-center w-full" style={{ backgroundColor: '#0A0F1C', height: '44px', padding: '0 80px', gap: '8px' }}>
        ...
        <span style={{ color: '#F5F7FA', fontFamily: 'Poppins', fontSize: '13px', fontWeight: '600' }}>Confirmar pedido</span>
      </div>
      ...
      <div className="flex md:hidden flex-col w-full" style={{ padding: '16px', gap: '20px' }}>
        ...
        >
          ...
          <span style={{ color: '#AAB3C5', fontFamily: 'Poppins', fontSize: '13px', lineHeight: '1.5' }}>
      ...
      <div className="hidden md:flex w-full" style={{ padding: '40px 80px', gap: '32px' }}>
        ...
        <div className="flex flex-col" style={{ flex: 1, gap: '24px' }}>
          <div className="flex flex-col" style={{ gap: '6px' }}>
            <span style={{ color: '#F5F7FA', fontFamily: 'Poppins', fontSize: '28px', fontWeight: '800' }}>Confirmar pedido</span>
            <span style={{ color: '#AAB3C5', fontFamily: 'Poppins', fontSize: '15px' }}>Completá el pago de forma segura con MercadoPago</span>
          </div>
          ...
          >
            ...
            <div className="flex items-center" style={{ gap: '14px' }}>
              ...
              <div className="flex flex-col" style={{ gap: '4px' }}>
                <span style={{ color: '#F5F7FA', fontFamily: 'Poppins', fontSize: '16px', fontWeight: '700' }}>MercadoPago</span>
                <span style={{ color: '#AAB3C5', fontFamily: 'Poppins', fontSize: '13px' }}>Pago seguro con tu cuenta</span>
              </div>
            </div>
            ...
            <div className="flex items-center" style={{ gap: '12px' }}>
              ...
              <span style={{ color: '#22C55E', fontFamily: 'Poppins', fontSize: '14px' }}>Hasta 12 cuotas sin interés</span>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <span style={{ color: '#AAB3C5', fontFamily: 'Poppins', fontSize: '13px' }}>Subtotal: $4.698.996 &nbsp;·&nbsp; Envío gratis</span>
