...
import { ChevronRight, Bitcoin, Hourglass, QrCode, Copy, ShieldCheck, Package, RotateCcw, CircleCheckBig } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col min-h-screen" style={{ backgroundColor: '#070B16' }}>
      ...
      <div
        ...
        style={{ backgroundColor: '#1A1000', padding: '10px 80px', gap: '8px' }}
      >
      ...
      {/* Main */}
      <div className="flex items-center w-full" style={{ padding: '40px 80px', gap: '30px' }}>
